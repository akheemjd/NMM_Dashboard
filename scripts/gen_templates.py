...
INCIDENTS_ROADWORK = '''
  <section class="sec">
    ...
    <div class="rows">
    <!--LOOP:coming_roadwork--><div class="rw"><div class="rw-head"><span class="rw-road">{{road}}</span><span class="rw-when">{{when}} · {{lanes}}</span></div><div class="rw-what">{{what}}</div></div><!--/LOOP:coming_roadwork-->
    </div>
  </section>
'''
