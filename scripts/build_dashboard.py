...
function renderTheft(d){
  ...
  var h='';incs.forEach(function(t){
    h+='<div class="theft-item"><div class="theft-method">'+t.method+'</div><div style="color:var(--salt);font-size:0.75rem;margin:2px 0;">'+t.title+' &middot; '+t.value+'</div><div style="font-size:0.625rem;color:var(--gravel);">'+t.location+'</div><div class="theft-prevention" style="margin-top:4px;">Prevention: '+t.prevention+'</div></div>';
  });
  return h;
}
