...
<div class="main">
  ...
  <div style="background:linear-gradient(135deg,#1a3a5c 0%,#152d4a 100%);border-radius:12px;padding:28px 24px 24px;margin-bottom:14px;color:#fff;text-align:center;position:relative;overflow:hidden;">
    ...
    <div style="font-size:19px;font-weight:800;margin-bottom:6px;letter-spacing:-.01em;">The Northern Mile Brief</div>
    <div style="font-size:13px;color:#8b9ec4;margin-bottom:16px;line-height:1.5;max-width:480px;margin-left:auto;margin-right:auto;">Fuel prices. Market shifts. What it means for your operation. One email, every Wednesday.</div>
    <div style="display:flex;flex-wrap:wrap;justify-content:center;gap:20px;margin-bottom:18px;font-size:10px;color:#8b9ec4;">
      <div style="background:rgba(255,255,255,.06);padding:5px 12px;border-radius:20px;">Weekly fuel &amp; rate snapshot</div>
      <div style="background:rgba(255,255,255,.06);padding:5px 12px;border-radius:20px;">Border crossing outlook</div>
      <div style="background:rgba(255,255,255,.06);padding:5px 12px;border-radius:20px;">Industry news that matters</div>
    </div>
