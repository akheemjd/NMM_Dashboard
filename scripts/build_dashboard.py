...
<nav style="background:var(--asphalt);border-bottom:1px solid var(--line);padding:0 24px;display:flex;justify-content:center;gap:32px;">
  <a href="{BASE_PATH}border-wait-times/" style="color:var(--gravel);text-decoration:none;font-size:0.75rem;font-weight:500;padding:8px 0;border-bottom:2px solid transparent;" onmouseover="this.style.borderColor='var(--salt)'" onmouseout="this.style.borderColor='transparent'">Border Times</a>
