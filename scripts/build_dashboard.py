...
.hero-province-list{display:grid;grid-template-columns:repeat(5,1fr);border:1px solid var(--line);border-radius:4px}.hero-prow{display:flex;justify-content:space-between;gap:16px;padding:6px 12px;font-size:0.875rem;border-right:1px solid var(--line);border-bottom:1px solid var(--line);background:var(--asphalt)}.hero-prow:nth-child(5n){border-right:none}.hero-prow:nth-child(n+6){border-bottom:none}.hero-prow .pcode{font-family:'IBM Plex Mono',monospace;color:var(--gravel);font-weight:500}.hero-prow .pprice{font-family:'IBM Plex Mono',monospace;font-weight:600;text-align:right}.pprice.high{color:var(--amber)}.pprice.low{color:var(--gantry)}
