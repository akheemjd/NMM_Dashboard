  ...
  <div style="display:flex;flex-wrap:wrap;gap:30px;justify-content:center;margin-bottom:20px;">
    <div style="max-width:320px;">
      <div style="display:flex;align-items:center;gap:10px;margin-bottom:0;">
        <img src="logo.jpg" alt="Northern Mile Media" style="height:44px;width:auto;flex-shrink:0;">
        <div style="font-weight:800;color:var(--blue);font-size:16px;line-height:1.2;">NORTHERN MILE MEDIA</div>
      </div>
    </div>
    <div>
