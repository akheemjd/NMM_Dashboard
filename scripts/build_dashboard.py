...
<div class="main">
  ...
  <div style="background:linear-gradient(135deg,#1a3a5c 0%,#152d4a 100%);border-radius:12px;padding:28px 24px 24px;margin-bottom:14px;color:#fff;text-align:center;position:relative;overflow:hidden;">
    ...
    <div style="font-size:13px;color:#8b9ec4;margin-bottom:16px;line-height:1.5;max-width:460px;margin-left:auto;margin-right:auto;">Every Wednesday at 7am, you get fuel prices, rate trends, and what they actually mean for your operation. Not a data dump. A briefing from someone who knows trucking.</div>
