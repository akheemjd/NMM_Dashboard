...
(function () {
  ...
  var iw, ih, x, y, gGrid, gLine, gArea, gx, gy, area, line, focus, curDomain = null, _baseX = null;
  ...
  if (ranges) ranges.addEventListener("click", function (e) {
    ...
    ranges.querySelectorAll("button").forEach(function (x) { x.classList.remove("on"); });
    b.classList.add("on");
