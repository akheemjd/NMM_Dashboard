...
python3 scripts/gen_templates.py && python3 scripts/build_chart_data.py && python3 scripts/build_templates.py && python3 scripts/build_provinces.py && python3 scripts/build_city_pages.py && python3 scripts/build_og.py && python3 scripts/build_sitemap.py && python3 scripts/check_coherence.py 2>&1
